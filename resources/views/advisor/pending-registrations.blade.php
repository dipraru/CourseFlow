...
<ul class="list-unstyled">
    ...
    <li class="nav-item">
        <a href="{{ route('advisor.pending') }}" class="nav-link active">
...
<div class="row mb-4">
    <div class="col-12">
        <h2 class="mb-3">Pending Registrations</h2>
    </div>
</div>
    ...
    <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        <form action="{{ route('advisor.approve', $reg) }}" method="POST" onsubmit="return confirm('Approve this registration?');">
                                            @csrf
                                            <button type="submit" class="btn btn-sm btn-success">Approve</button>
                                        </form>

                                        <form action="{{ route('advisor.reject', $reg) }}" method="POST" onsubmit="return confirm('Reject this registration?');">
                                            @csrf
                                            <input type="hidden" name="rejection_reason" value="Rejected by advisor">
        ...
        @else
            <div class="p-4 text-center text-muted">
                ...
                <p class="mt-2">No pending registrations.</p>
            </div>
        @endif
    </div>
</div>
